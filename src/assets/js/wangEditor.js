!(function(e, t) {
  ...
  var z = {
      ...
      uploadImgHooks: { before: function(e, t, n) {}, success: function(e, t, n) {}, fail: function(e, t, n) {}, error: function(e, t) {}, timeout: function(e, t) {} },
      qiniu: !1
    },
    J = {
      ...
      onClick: function(e) {
        ...
        return n.equal(i)
          ? A
            ...
            : ((c = o('<code>' + r + '</code>')), t.cmd.do('insertElem', c), t.selection.createRangeByElem(c, !1), void t.selection.restoreSelection())
              ...
              (C.onreadystatechange = function() {
                ...
                if (4 === C.readyState) {
                  if (C.status < 200 || C.status >= 300)
                    return f.error && 'function' == typeof f.error && f.error(C, n), void t._alert('上传图片发生错误', '上传图片发生错误，服务器返回状态是 ' + C.status)
